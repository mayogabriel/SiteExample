(function () {
    ...
    RoleListController.$inject = ['userService', 'roleService', '$location', 'toaster', '$translate', '$q', 'permissionService'];
    function RoleListController(userService, roleService, $location, toaster, $translate, $q, permissionService) {
